...
@Component({
  selector: 'app-registrar-reclutador',
  templateUrl: './registrar-reclutador.component.html',
  styleUrls: ['./registrar-reclutador.component.css']
})
export class RegistrarReclutadorComponent implements OnInit{
